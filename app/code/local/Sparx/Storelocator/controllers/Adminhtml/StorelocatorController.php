...
class Sparx_Storelocator_Adminhtml_StorelocatorController extends Mage_Adminhtml_Controller_Action
{
		...
		{
			try {
				$ids = $this->getRequest()->getPost('storelocator_ids', array());
				foreach ($ids as $id) {
                      $model = Mage::getModel("storelocator/storelocator");
...
<markers>';
			...
			Mage::getSingleton("adminhtml/session")->addSuccess(Mage::helper("adminhtml")->__("XML was successfully generated."));
			$this->_redirect('*/*/');
		}
